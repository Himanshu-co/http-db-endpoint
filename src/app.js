...
const mongohelper = require('./helper/mongo/mongo')
const redishelper = require('./helper/redis/redis')
const mysqlhelper = require('./helper/mysql/mysql')
...
//             return res.send(error)
//         }
//         res.send('Number of documents modified are ' + count)
//     })
